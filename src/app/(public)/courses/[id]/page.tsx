...
export async function generateMetadata({
  ...
  if (course.id === '2') {
    return {
      title:
        'Global Education Recruiter Training Program | Build a Career in International Student Recruitment',
      description:
...
export default async function CourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (course.relatedCourses && course.relatedCourses.length > 0) {
    ...
    relatedCourses = allCourses.filter((c) => course.relatedCourses!.includes(c.id)).slice(0, 3);
  } else {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section
        className="relative pb-16 pt-24 text-white md:pb-20 md:pt-32"
        style={{
          background: 'linear-gradient(to bottom, #0a2d5a 0%, #062346 50%, #041a2e 100%)',
          overflow: 'hidden',
        }}
      >
        ...
        <div className="relative z-10">
          <div className="mx-auto max-w-container px-4 md:px-lg lg:px-xl">
            <div className="max-w-[610px] pt-12 md:pt-0">
              <p className="mb-4 font-primary text-[20px] tracking-[-0.5px] text-accent-yellow md:text-heading-2">
                Courses details
              </p>
              <h1 className="mb-0 font-primary text-[32px] font-bold leading-[1.2] tracking-[-2px] md:text-[48px] lg:text-[60px]">
                {course.id === '2'
              ...
              {course.id === '2' && (
                <h2 className="mt-2 font-primary text-[20px] font-semibold tracking-[-0.5px] text-white/90 md:text-[24px] lg:text-[28px]">
                  Training Program
                </h2>
              )}
              {course.id === '3' && (
      ...
      {/* Course Info Bar */}
      <div className="my-2 border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-container px-4 md:px-lg lg:px-xl">
          <div className="relative flex min-h-[60px] flex-col items-center justify-center py-4 md:flex-row md:py-5">
            {/* Desktop Layout */}
              ...
              {course.id !== '1' && (
                <>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative h-[60px] min-h-[60px] w-[60px] min-w-[60px] flex-shrink-0 overflow-hidden rounded-full">
                    ...
                    <span className="whitespace-nowrap text-body-md font-semibold text-text-primary">
                      Instructor:{' '}
            ...
            {/* Mobile Layout */}
            <div className="flex w-full flex-col items-center justify-center gap-3 py-4 md:hidden">
              {course.id !== '1' && (
      ...
      <Section padding="lg" background="white">
        <div className="mx-auto max-w-container px-4 md:px-lg lg:px-xl">
          <div className="lg:gap-15 grid grid-cols-1 gap-8 lg:grid-cols-[2fr_1fr]">
            <div>
      ...
      <Section padding="lg" background="gray" className="bg-gray-100">
        <div className="mx-auto max-w-container px-4 md:px-lg lg:px-xl">
          <h2 className="mb-12 text-center font-primary text-[28px] font-bold text-text-primary md:text-[42px] lg:text-display-2">
            Related courses
          </h2>
